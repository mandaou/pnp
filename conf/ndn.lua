...
local NDN_DICT = {
   ...
   [363] = {name = "ApplicationParametersPnpAdd" , field = ProtoField.string("ndn.app_params.pnp_add", "PNPAddMessage"), value = getUriFromName},
   [364] = {name = "ApplicationParametersPnpRemove" , field = ProtoField.string("ndn.app_params.pnp_remove", "PNPRemoveMessage"), value = getUriFromName},
   [365] = {name = "ApplicationParametersPnpSet" , field = ProtoField.string("ndn.app_params.pnp_set", "PNPSetMessage"), value = getUriFromName},
   [366] = {name = "ApplicationParametersPnpGet" , field = ProtoField.string("ndn.app_params.pnp_get", "PNPGetMessage"), value = getUriFromName},
   [367] = {name = "ApplicationParametersPnpGetLpm" , field = ProtoField.string("ndn.app_params.pnp_getlpm", "PNPGetLpmMessage"), value = getUriFromName},
